/**
 * @typedef {Object} INetmask
 * @property {string} base - Bits
 * @property {string} submask - Submask
 */

/**
 * @typedef {Object} IPData
 * @property {string} address - IP address
 * @property {string} addressHex - IP address in hex format
 * @property {number} addressDecimal - IP address in int format
 * @property {INetmask} netmask
 * @property {string} wildcard 
 * @property {string} networkAddr
 * @property {string} netMin - Minimum possible host for this IP range
 * @property {string} netMax - Maximum possible host for this IP range
 * @property {string} broadcastAddr - Broadcast IP for this format
 * @property {string} ipClass - Type of IP
 * @property {number} subnets - Amount of subnets
 * @property {number} hosts - Amount of possible hosts for this IP format
 */
...
/**
 * Receives an IP as a paremeter of string format.
 * IP input must follow slash notation. E.g:
 * 192.168.0.0/24
 * 
